    ...
    <div style={{ position: 'relative', minHeight: '100vh' }}>
      ...
      <div
        style={{
          ...
          inset: 0,
          zIndex: -1,
          pointerEvents: 'none', // avoid blocking UI
        }}
      >
      ...
      <div style={{ position: 'relative', zIndex: 1, color: 'white', padding: '2rem' }}>
        <div className="call-to-action">
          <div className="text">
            ...
            <p>
              Our AI turns plain text into deeply expressive, human-sounding speech that resonates
              with listeners.
            </p>
          </div>
        ...
        <AnimatedContent
          ...
          delay={0}
        >
          <section id="overview" className="how-it-works">
            <h2>Overview</h2>
            <div className="steps">
              <div className="step">
            ...
            <div className="steps">
              <div className="step">
                ...
                <p>Instantly convert written text into natural-sounding voice output.</p>
              </div>
              <div className="step">
                <h3>2. Voice Cloning Mode</h3>
                <p>Generate personalized voice samples with AI-powered cloning.</p>
              </div>
              <div className="step">
                <h3>3. Audio Download</h3>
                <p>Save your generated voice outputs directly in high-quality formats.</p>
              </div>
            </div>
